data segment
    msg1 db 0dh, 0ah, "enter the characters... $"  ; 0ah is for new line and 0dh is for carriage return
    msg2 db ": $"
    msg3 db 0dh, 0ah, 0dh, 0ah, "is a palindrome: $"
    msg4 db 0dh, 0ah, "$"
    msg5 db 0dh, 0ah, "enter the length of string: $"
...
back:
    ...
    mov dl, bl
    add dl, 30h     ; 48 decimal value is 30 in hex
    int 21h
    inc bl
